...
//                 }}
//               >
//                 <Typography sx={{fontSize:"25px", fontWeight:"bold"}}>{category.title}</Typography>
//               </Button>
//             </div>
...
//                     marginBottom="16px"
//                   >
//                     <Card onClick={() => handleImageClick(item.image)} sx={{height:"230px"}}>
//                       <CardMedia
//                         component="img"
//                       //   height="200px"
//                         image={item.image}
  ...
  return (
    <Box sx={{ backgroundColor: "#fcba03", paddingBottom: "2px", margin: "0" }}>
      ...
      <Container>
        ...
        <Dialog open={!!zoomedImages} onClose={handleCloseZoom}>
