...
export const EnglishCategories: Category[] = [
  ...
  },
  {
    ...
    items: [
      {
        title: "Kebap roll", images: [TortillaKebapMain,TortillaKebap_1,TortillaKebap_2 ],
        price: "38₪"
      },
      {
        title: "Chick fillet", images: [TortillaChickenMain,TortillaChicken_1,TortillaChicken_2],
        price: "35₪"
      },
      {
